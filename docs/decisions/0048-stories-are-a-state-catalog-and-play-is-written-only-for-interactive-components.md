# ADR-0048: story は状態のカタログとし、play は操作で状態が変わる部品にだけ書く

- Status: Accepted
- Date: 2026-09-20
- 関連: ADR-0047 (framework) / ADR-0049 (play の操作とブラウザテストの分担) / ADR-0052 (story の a11y 検査) / ADR-0050 (story の置き場所と対象) / ADR-0051 (トークンの story が読む CSS の作り方) / ADR-0015 (層) / ADR-0019 (Transition)
