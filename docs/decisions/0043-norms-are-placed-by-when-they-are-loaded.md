# ADR-0043: 規範の置き場所は読み込まれる契機で決め、Bash で打つだけの操作の規範は AGENTS.md に置く

- Status: Accepted
- Date: 2026-09-23
- 関連: ADR-0001 (規範・経緯・履歴の置き場所) / ADR-0042 (rules の 1 項目に書くもの)
...
| `.claude/rules/` (`paths` なし)                      | セッションの開始時。`.claude/CLAUDE.md` と同じ優先度                       |
