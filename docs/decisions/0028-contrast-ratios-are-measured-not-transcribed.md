...
Primer が数値を書き写さない形に到達していることと、`.claude/rules/docs.md`「数値」が動く数値を書かず測り方だけ残すと定めていることは一致する。
...
比の主張を持つのは 1 箇所とし、他は文書番号か見出しで指す。`.claude/rules/docs.md`「ドキュメントの間」が持つ規範を、コントラスト比へ当てる。
