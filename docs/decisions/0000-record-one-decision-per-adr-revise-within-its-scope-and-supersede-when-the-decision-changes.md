...
- Status: Accepted
- Date: 2026-09-24
- 関連: ADR-0051 (設計ガイドの置き場所) / ADR-0004 (コメントが指す先)
...
| 部品をまたいで守る作法の説明と、その作法で組む手順・落とし穴への対処 | `docs/guides/` の設計ガイド (ADR-0051) |
...
- 節の立て方と本文の書き方は `docs/guides/writing-docs.md`「ADR を書く」が持つ
