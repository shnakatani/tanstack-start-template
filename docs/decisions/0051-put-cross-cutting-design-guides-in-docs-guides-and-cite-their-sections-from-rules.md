# ADR-0051: 部品をまたぐ作法の説明と手順は docs/guides に置き、rules は出典としてその節を指す

- Status: Accepted
- Date: 2026-09-24
- 関連: ADR-0001 (文書の層と参照の向き) / ADR-0003 (読み込まれる契機で置き場所を決める) / ADR-0052 (設計ガイドの書き方)
...
- 層の分け方と参照の向きは ADR-0001、ガイドの中の書き方は ADR-0052 が持つ
