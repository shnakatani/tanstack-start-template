# ADR-0009: GitHub Actions の定義は zizmor で検査し、action は commit SHA で固定する
...
| 5   | 設定は `.github/zizmor.yml` に置き、`dependabot-cooldown` の下限を 3 日にする  | 待機の日数は ADR-0008 が決める。zizmor 1.30.1 の既定 7 日 (2026-09-23 確認) に合わせると、却下した案を検査が強制する                                                                                                          |
