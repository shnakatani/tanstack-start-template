...
この ADR を書いた 2026-09-13 時点で、`startTransition` / `useTransition` / `useDeferredValue` / `useOptimistic` を使う箇所は `src/` に無かった。`useDeferredValue` はその後 ADR-0033 (2026-09-23) が検索の一覧で使い始めた。
