# ADR-0044: story は状態のカタログとし、play は合成イベントで、操作で状態が変わる部品にだけ書く (実イベントの規律はブラウザテスト)

- Status: Accepted
- Date: 2026-09-20
- 関連: ADR-0043 (framework) / ADR-0047 (story の a11y 検査) / ADR-0036 (待機) / ADR-0037 (実イベント) / ADR-0038 (animation) / ADR-0045 (story の置き場所と対象) / ADR-0046 (トークンの story が読む CSS の作り方) / ADR-0013 (層) / ADR-0017 (Transition)
