...
function Field({
  ...
  return (
    <div
      // oxlint-disable-next-line jsx-a11y/prefer-tag-over-role -- fieldset は native border と legend 前提の既定意匠を持ち込み、vertical/horizontal 切り替えレイアウトと衝突する
      role="group"
      data-slot="field"
  ...
  const content = useMemo(() => {
    ...
    return (
      <ul className="ml-4 flex list-disc flex-col gap-1">
        {/* oxlint-disable-next-line react/no-array-index-key -- 中身がテキストだけで state も DOM identity も持たず、要素を取り違えても表示結果は変わらない */}
