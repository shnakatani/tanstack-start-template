...
/**
 * 状態のカタログは `data-table.stories.tsx` が持つ (ADR-0048)。ここに残すのは構造の契約で、
 ...
 *
 * この部品は args だけで状態が決まるので story に play を書かない (ADR-0048)。play の無い
 * story は描画と axe しか走らせないため、上の契約はここでしか固定できない (ADR-0049 の
 * 役割分担)。
 */
describe("DataTable", () => {
