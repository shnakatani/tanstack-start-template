 ...
 * 違いは retry の予算だけなので、名前でどちらのつもりかを表明する (docs/guides/testing/waiting-and-assertions.md「不在を 2 つの名前で書き分ける理由」)。
 *
 ...
 * 予算が要る (docs/guides/testing/user-interactions.md「animation を戻すテストを書く」)。`expectAbsent` に置き換えると unmount を待たずに落ちる。
 *
