 ...
 * animation を戻したテスト (docs/guides/testing.md「animation を戻すテストを書く」) では animate-out の完了まで残る。要素の存在だけを見ると
...
/** 指定ラベルの textbox がすべて空であることを検証する。値は locator の matcher で見る (docs/guides/testing.md「同期読みを書き換える」) */
